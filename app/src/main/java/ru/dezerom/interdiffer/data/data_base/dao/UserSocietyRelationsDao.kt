...
interface UserSocietyRelationsDao {
    ...
    @Query("SELECT * FROM UserSocietyRelationDataModel WHERE userId = :userId ORDER BY orderNumber ASC")
    suspend fun getUserRelations(userId: Int): List<UserSocietyRelationDataModel>
